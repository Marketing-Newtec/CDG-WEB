...
export default function App() {
  ...
  // Listado completo de 18 marcas incluyendo Healcath y Healcath Plus
  const marcas = [
      ...
      <main>
        ...
        <section id="nosotros" className="py-24 lg:py-32 px-6 bg-white/5">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center text-center lg:text-left">
            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative order-2 lg:order-1">
              <div className="rounded-[40px] lg:rounded-[60px] overflow-hidden shadow-2xl border-4 border-white/10 aspect-[4/5] relative group">
                <img src="https://indigo-spider-680423.hostingersite.com/wp-content/uploads/2026/03/cdg-frente-importadora-scaled.jpg" alt="Sede CDG" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" referrerPolicy="no-referrer" />
            ...
            <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="order-1 lg:order-2">
              ...
              <p className="font-sans text-lg lg:text-xl text-white/70 mb-10 lg:mb-12 leading-relaxed">CDG es una empresa Tandilense con proyección internacional, especializada en la importación de tecnología médica avanzada. Garantizamos seguridad, trazabilidad y eficiencia en cada distribución.</p>
        ...
        {/* Brands Slider - Versión Estable con Logos en Color y Fondo F6F6F6 */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16 lg:mb-24">
            <div className="flex flex-col items-center md:items-start">
              <div className="mb-6 lg:mb-8"><img src="https://indigo-spider-680423.hostingersite.com/wp-content/uploads/2026/03/CDG-2-scaled.png" alt="CDG Logo" className="h-16 lg:h-20 w-auto brightness-0 invert" referrerPolicy="no-referrer" /></div>
              <p className="font-sans text-white/40 leading-relaxed">Importación de <br /> productos médicos.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="font-sans text-white/70 font-bold text-lg uppercase tracking-widest">MAX CONTINENTAL</div>
            </div>
            <div className="flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-6 font-sans">
                ...
                <li className="flex flex-col md:flex-row items-center md:items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold">Parque Industrial - Tandil, Argentina</p>
                  </div>
                </li>
              </ul>
            </div>
          </div>
          <div className="pt-8 lg:pt-12 border-t border-white/5 text-center text-white/20 text-xs font-bold tracking-widest uppercase">
